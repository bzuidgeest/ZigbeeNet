    ...
    internal class EZSPYAMLDefinitionParser
    {
        ...
        private void ProcessSimpleTypeDefinitions(string sectionName, List<Typedef> typedefs)
        {
            try
            {
                ...
                string outputDir = Path.Combine(_settings.OutputDirectory, Sanitize.SanitizeSectionName(sectionName));
        ...
        private void ProcessComplexTypeDefinition(string sectionName, Typedef typedef)
        {
            try
            {
                ...
                // Create output directory for this section
                string sanitizedSectionName = Sanitize.SanitizeSectionName(sectionName);
                ...
                fileContent.AppendLine($"namespace ZigBeeNet.EmberV8Plus.{sanitizedSectionName}.Types;");
