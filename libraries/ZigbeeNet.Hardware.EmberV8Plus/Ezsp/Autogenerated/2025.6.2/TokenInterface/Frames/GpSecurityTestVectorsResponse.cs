...
/// Frame value: 0x0117
/// </summary>
public class GpSecurityTestVectorsResponse : EzspFrameResponseV8Plus, IFrameIdentifier
{
    /// <summary>
    /// The frameId of the frame
    /// </summary>
    public static ushort FrameId { get => 0x0117; }
    /// <summary>
    ...
    public static EzspFrameResponseV8Plus Parse(ReadOnlySpan<byte> frameBytes)
    {
        ...
        GpSecurityTestVectorsResponse frame = new GpSecurityTestVectorsResponse();
