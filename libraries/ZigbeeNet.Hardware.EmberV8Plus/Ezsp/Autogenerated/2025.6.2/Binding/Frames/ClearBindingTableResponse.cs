...
/// Frame value: 0x002A
/// </summary>
public class ClearBindingTableResponse : EzspFrameResponseV8Plus, IFrameIdentifier
{
    /// <summary>
    /// The frameId of the frame
    /// </summary>
    public static ushort FrameId { get => 0x002A; }
    /// <summary>
    ...
    public static EzspFrameResponseV8Plus Parse(ReadOnlySpan<byte> frameBytes)
    {
        ...
        ClearBindingTableResponse frame = new ClearBindingTableResponse();
