...
/// Frame value: 0x00B5
/// </summary>
public class ZllSetRxOnWhenIdleResponse : EzspFrameResponseV8Plus, IFrameIdentifier
{
    /// <summary>
    /// The frameId of the frame
    /// </summary>
    public static ushort FrameId { get => 0x00B5; }
    /// <summary>
    ...
    public static EzspFrameResponseV8Plus Parse(ReadOnlySpan<byte> frameBytes)
    {
        ...
        ZllSetRxOnWhenIdleResponse frame = new ZllSetRxOnWhenIdleResponse();
