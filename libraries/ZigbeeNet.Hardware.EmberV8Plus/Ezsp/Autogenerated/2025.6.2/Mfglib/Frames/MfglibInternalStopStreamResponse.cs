...
/// Frame value: 0x0088
/// </summary>
public class MfglibInternalStopStreamResponse : EzspFrameResponseV8Plus, IFrameIdentifier
{
    /// <summary>
    /// The frameId of the frame
    /// </summary>
    public static ushort FrameId { get => 0x0088; }
    /// <summary>
    ...
    public static EzspFrameResponseV8Plus Parse(ReadOnlySpan<byte> frameBytes)
    {
        ...
        MfglibInternalStopStreamResponse frame = new MfglibInternalStopStreamResponse();
