...
/// Frame value: 0x0150
/// </summary>
public class ConcentratorStopDiscoveryResponse : EzspFrameResponseV8Plus, IFrameIdentifier
{
    /// <summary>
    /// The frameId of the frame
    /// </summary>
    public static ushort FrameId { get => 0x0150; }

    public static EzspFrameResponseV8Plus Parse(ReadOnlySpan<byte> frameBytes)
    {
        EmberResponseHeader header = EzspFrameResponseV8Plus.ParseHeader(frameBytes);
        ConcentratorStopDiscoveryResponse frame = new ConcentratorStopDiscoveryResponse();
