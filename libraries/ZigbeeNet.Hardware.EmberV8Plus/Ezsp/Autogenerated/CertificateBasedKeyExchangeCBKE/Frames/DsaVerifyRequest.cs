...
/// Frame value: 0x00A3
/// </summary>
public class DsaVerifyRequest : EzspFrameRequest
{
    /// <summary>
    ...
    /// </summary>
    public sl_zigbee_certificate_data_t signerCertificate { get; set; }

    /// <summary>
    /// The signature of the signed data.
    /// </summary>
    public sl_zigbee_signature_data_t receivedSig { get; set; }
